            ...
            <table class="table">
                ...
                <tr v-for="page in currentProfile.pages">
                    ...
                    <td>
                        ...
                        <input v-model="page.regEx" type="text" placeholder="RegEx to match agains URL"/>
                        <span class="text-muted">/gim</span>
                    </td>
                    <td>
                        <button class="btn btn-danger btn-xs" @click="currentProfile.removePage(page)"><i
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group" v-bind:class="{'has-success': urlValid, 'has-error': !urlValid}" style="margin-bottom: 0">
                        <input placeholder="URL" class="form-control" @input="validateUrl"/>
...
export default Vue.component('pages-edit', {
  ...
  methods: {
    ...
    validateUrl(event) {
      this.urlValid = this.currentProfile.isActive(event.target.value)
    }
  }
})